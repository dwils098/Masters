...
\maketitle
	...
	\section{Network Layer}
        ...
        feature of LxC. A general example of namespace isolation is the \emph{PID
          ...
          to manage processes within a distributed environment. But first we need to
          clarify some assumptions to narrow our scope of research a bit. The first
          assumption that we make is relative to the representation of a process within a
          PaaS environment, since the scope of PaaS environment is Application and 
          \subsection{Security}
