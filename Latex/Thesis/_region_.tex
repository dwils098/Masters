\message{ !name(thesis.tex)}%---------------------Start of preamble--------------------------
...
x       that is transparent to both the provider and the consumer.
     ...
     \begin{figure}[h]
       ...
       \caption{Peer-to-Peer Cloud System Architecture \label{p2pcs_arch}}
     \end{figure}
     ...
     % Figure
     \begin{figure}[h]
       \includegraphics{/images/overview_arch.png}
     ...
     \begin{figure}
       \includegraphics{/images/arch_net_ring_fellow.png}
     \end{figure}
     ...
     \begin{figure}[h]
       \includegraphics{/images/arch_ring.png}
     ...
     \begin{figure}
       \includegraphics{/images/arch_fellowship.png}
     ...
     \begin{figure}[h]
       ...
       \begin{tikzpicture}[%
                  grow via three points={one child at (0.5,-0.7) and two children at (0.5,-0.7) and
                    ...
                    (\tikzchildnode.west)}] 
                \node {API Specification} 
                child { node {Databases and Storages}} 
                child { node {Communication and Networking}} 
                child { node [optional]{Load Balancing and Scalability}} 
                child { node {Security}} 
                child { node [optional]{Application Deployment and Management}};
       \end{tikzpicture}
     ...
     \\ \center{$u(t)= K_P e(t) + K_i \int_0^t e(t) dt + K_d \frac{de(t)}{dt}$} \\
     ...
     \begin{sequencediagram}
       \newinst{connode}{Contributing Node}
       \newinst[2]{appd}{Application Deployer}
       
       \mess{connode}{Connected}{appd}
     ...
     \begin{figure}[h]
       \includegraphics{\images\web_protocol.png}
     ...
     \begin{figure}
       \includegraphics{/images/calculator.png}
     ...
     \begin{figure}[h]
       \includegraphics{/images/calc_app_dep.png}
     ...
     \begin{figure}[h]
       \includegraphics{/images/calc_home.png}
     ...
     % Support Sentence: Node Overview
     \begin{figure}
       \includegraphics{/images/calc_node.png}
     ...
     \begin{figure}[h]
       \includegraphics{/images/calc_final_overview.png}
     ...
     \begin{figure}[h]
       \includegraphics{/images/ef1.png}
     ...
     \begin{figure}
       \includegraphics{/images/ef2.png}
     ...
     \begin{figure}
       \includegraphics{/images/ef3.png}
     ...
     \begin{figure}
       \includegraphics{/images/mdts_overview.png}
     ...
     \begin{figure}
       \includegraphics{/images/mdts_app_dep.png}
     ...
     \begin{figure}[h]
       \includegraphics{/images/mdts_home.png}
     ...
     \begin{figure}
       \includegraphics{/images/mdts_files_db_schema.png}
       \caption{Files table schema.}\label{files_scm}
     \end{figure}

     \begin{figure}
       \includegraphics{/images/mdts_results_db_schema.png}
     ...
     \begin{figure}[h]
       \includegraphics{/images/mdts_worker_node.png}
...
\message{ !name(thesis.tex) !offset(-4105) }
