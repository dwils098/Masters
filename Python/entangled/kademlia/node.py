...
#        df.addCallback(self._refreshKBuckets)
        #protocol.reactor.callLater(1, self.printContacts)
        ...
        def checkResult(result):
            ...
            if type(result) == dict:
                ...
                if key in self._dataStore:
                    ...
                    print "... oops it appears that the value doesn't exist at all in the DHT."
                    outerDf.callback(result)
    ...
    def _iterativeFind(self, key, startupShortlist=None, rpc='findNode'):
        ...
        if startupShortlist == None:
            ...
            if len(shortlist) == 0:
                ...
                print "This node doesn\'t know of any other nodes."
